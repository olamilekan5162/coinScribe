...
const Explore: React.FC = () => {
  ...
  const allPosts: Post[] = [
    ...
    },
    {
      ...
      excerpt: "Understanding the mental aspects of cryptocurrency trading and how to develop a winning mindset.",
      author: {
        name: "Lisa Wang",
      ...
      readTime: 14,
      image: "https://images.pexels.com/photos/7567521/pexels-photo-7567521.jpeg?auto=compress&cs=tinysrgb&w=600",
  ...
  const popularTags: string[] = [
    'Web3', 'DeFi', 'NFT', 'Smart Contracts', 'Ethereum', 
    'Bitcoin', 'Trading', 'Yield Farming', 'DAO', 'Metaverse'
  ];
        ...
        <div className={styles.results}>
          <div className={styles.resultsHeader}>
            <h2 className={styles.resultsTitle}>
              {sortedPosts.length} {sortedPosts.length === 1 ? 'Story' : 'Stories'}
              {searchQuery && (
